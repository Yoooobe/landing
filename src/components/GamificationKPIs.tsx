...
export default function GamificationKPIs() {
  ...
  const k = m.gamificacaoPage.kpis;
      ...
      <div className="container mx-auto max-w-6xl px-4">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h2 className="mb-6 font-heading text-3xl font-black text-white md:text-5xl">
            {k.titleBefore}{" "}
            <span className="bg-gradient-to-r from-yoobe-purple to-fuchsia-600 bg-clip-text text-transparent">{k.titleGradient}</span>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {k.items.map((kpi, idx) => {
            ...
            return (
              <div key={kpi.title} className="group rounded-2xl border border-white/10 bg-[#121824] p-8 transition-colors hover:bg-[#161d2b]">
                ...
                <div className="mt-auto h-1.5 w-full overflow-hidden rounded-full bg-white/5">
                  <div
                    className="h-full rounded-full bg-gradient-to-r from-brand-orange to-yoobe-neon-pink transition-all duration-1000 group-hover:w-full"
