      ...
      <div className="container mx-auto max-w-3xl px-4">
        <div className="mb-16 text-center">
          ...
          <h2 className="font-heading text-3xl font-black text-white md:text-5xl">
            {f.titleBefore}{" "}
            <span className="bg-gradient-to-r from-yoobe-purple to-fuchsia-600 bg-clip-text text-transparent">{f.titleGradient}</span>
            {f.titleAfter}
          </h2>
        </div>
          ...
          {f.items.map((faq, idx) => (
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  className={`h-5 w-5 flex-shrink-0 text-white/50 transition-transform duration-300 ${openIndex === idx ? "rotate-180 text-yoobe-purple" : ""}`}
                />
              </button>
