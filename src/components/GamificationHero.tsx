    ...
    <section className="hero-theme-section relative overflow-hidden bg-brand-navy-dark pb-24 pt-32">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <motion.div
          ...
          className="absolute left-[1%] top-[30%] hidden w-[240px] overflow-hidden rounded-2xl border border-white/12 bg-slate-950 shadow-[0_24px_70px_rgba(0,0,0,0.6)] xl:block"
          style={{ animation: "float 9s ease-in-out infinite 1s" }}
        >
          <div className="flex items-center justify-between border-b border-white/10 bg-slate-900/95 px-3 py-2">
            <div className="flex items-center gap-1.5">
              <span className="h-2 w-2 rounded-full bg-red-500/80" />
              <span className="h-2 w-2 rounded-full bg-yellow-500/80" />
              <span className="h-2 w-2 rounded-full bg-green-500/80" />
            </div>
            <span className="font-mono text-[0.52rem] text-white/40 tracking-wider">gestor.4unik.io</span>
          </div>
          <div style={{ aspectRatio: "16/10" }} className="relative overflow-hidden bg-slate-900">
            <Image
        ...
        <motion.div
          ...
          className="absolute bottom-[8%] right-[3%] hidden w-[260px] overflow-hidden rounded-2xl border border-white/12 bg-slate-950 shadow-[0_24px_70px_rgba(0,0,0,0.6)] lg:block xl:w-[280px]"
        ...
        >
          <div className="flex items-center justify-between border-b border-white/10 bg-slate-900/95 px-3 py-2">
            ...
            <span className="font-mono text-[0.52rem] text-white/40 tracking-wider">gestor.4unik.io · Editor</span>
          </div>
