      ...
      <div className="container mx-auto px-4 max-w-6xl">
        <div className="text-center mb-20 relative z-10 text-white">
          ...
          <h2 className="text-3xl md:text-5xl font-black mb-6 font-heading">
            {h.titleBefore}{" "}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-yoobe-neon-pink to-orange-500">
              {h.titleGradient}
            </span>
            {h.titleAfter}
          </h2>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start relative z-10 mb-20">
          ...
          {steps.map((step, i) => (
            ...
            >
              <div className="w-20 h-20 rounded-full bg-surface-elevated border-2 border-white/10 flex items-center justify-center text-2xl font-bold text-white mb-6 shadow-xl font-heading relative">
                {step.num}
                {/* Active glow pip */}
                <div className="absolute top-0 right-0 w-4 h-4 rounded-full bg-brand-orange shadow-[0_0_10px_rgba(249,115,22,0.8)] border-2 border-surface-elevated"></div>
              </div>
        ...
        >
          {architectureImageUrl ? (
            <div className="relative aspect-21/9 overflow-hidden rounded-3xl border border-white/5 bg-white/2 shadow-2xl">
              <Image
            ...
            <>
              ...
              <div className="relative aspect-21/9 bg-white/2 border border-white/5 rounded-3xl overflow-hidden backdrop-blur-sm p-8 flex items-center shadow-2xl">
                ...
                <div className="w-full flex justify-between items-center relative z-10 px-8">
                  <div className="flex flex-col gap-6 w-1/4">
                    <div className="bg-surface-elevated border border-white/10 rounded-2xl p-4 flex items-center gap-3 shadow-lg transform -rotate-2 hover:rotate-0 transition-transform">
                  ...
                  <div className="flex flex-col gap-6 w-1/4">
                    ...
                    <div className="bg-surface-elevated border border-white/10 rounded-2xl p-4 flex flex-col gap-3 shadow-lg transform -rotate-1 hover:rotate-0 transition-transform">
