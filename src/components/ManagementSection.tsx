...
export default function ManagementSection() {
  ...
  const features = man.features.map((item, i) => ({ ...item, icon: ICONS[i] }));
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        <div className="relative z-10 mb-16 text-center text-white">
          ...
          <h2 className="mb-6 font-heading text-3xl font-black md:text-5xl">
            {man.titleBefore} <span className="bg-gradient-to-r from-blue-400 to-indigo-500 bg-clip-text text-transparent">{man.titleGradient}</span>
            {man.titleAfter}
          </h2>
