...
export default function CasosPageCta({ contactSectionId }: { contactSectionId?: string | null } = {}) {
  ...
  return (
    <section
      ...
      className="relative overflow-hidden border-t border-white/5 bg-brand-navy py-24 text-center"
    >
      <div className="absolute inset-0 bg-linear-to-t from-brand-orange/10 to-transparent opacity-50" />
