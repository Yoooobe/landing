...
export default function GamificationFlow() {
  ...
  const f = m.gamificacaoPage.flow;
      ...
      <div className="container relative z-10 mx-auto max-w-5xl px-4">
        <div className="mx-auto mb-20 max-w-3xl text-center">
          ...
          <h2 className="mb-6 font-heading text-3xl font-black text-white md:text-5xl">
            {f.titleBefore}{" "}
            <span className="bg-gradient-to-r from-yoobe-purple via-unik-blue-soft to-demo-cyan bg-clip-text text-transparent">{f.titleGradient}</span>{" "}
            {f.titleAfter}
          </h2>
        ...
        <div className="relative space-y-16 md:space-y-0">
          {f.steps.map((step) => (
            <div key={step.num} className="relative flex w-full flex-col items-center last:mb-0 md:mb-16 md:flex-row md:justify-between">
              ...
              <div className="w-full flex-shrink-0 md:w-5/12">
                <div className="group rounded-2xl border border-white/10 bg-surface-panel p-8 transition-all hover:border-demo-cyan/25 hover:bg-surface-elevated">
                  <div className="mb-6 flex items-center gap-3">
                    <span className="bg-gradient-to-r from-yoobe-purple to-demo-cyan bg-clip-text font-mono text-3xl font-bold text-transparent">{step.num}</span>
