...
export default function GamificationStats() {
  ...
  const s = m.gamificacaoPage.stats;
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {s.items.map((stat, idx) => (
            <div key={idx} className="rounded-2xl border border-white/10 bg-[#121824] p-8 transition-transform duration-300 hover:-translate-y-2">
