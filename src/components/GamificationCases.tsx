...
export default function GamificationCases() {
  ...
  const c = m.gamificacaoPage.cases;
      ...
      <div className="container relative z-10 mx-auto max-w-6xl px-4">
        <div className="mx-auto mb-16 max-w-3xl text-center">
          ...
          <h2 className="mb-6 font-heading text-3xl font-black text-white md:text-5xl">
            {c.titleBefore}{" "}
            <span className="bg-gradient-to-r from-yoobe-purple to-fuchsia-600 bg-clip-text text-transparent">{c.titleGradient}</span>{" "}
            {c.titleAfter}
          </h2>
            ...
            <button
              ...
              className={`rounded-full border px-6 py-3 text-sm font-bold transition-all ${
                activeTab === item.id
                  ...
                  : "border-white/10 bg-[#121824] text-white/60 hover:border-white/30 hover:text-white"
              }`}
            >
              {item.id}
            </button>
        ...
        <div className="relative rounded-3xl border border-white/10 bg-[#121824] p-8 transition-all duration-500 lg:p-12">
          {c.items.map((item) => (
            <div
              key={item.id}
              ...
              <div className="flex items-center justify-center">
                <div className="grid w-full grid-cols-2 gap-6">
                  {item.metrics.map((metric) => (
                    ...
                    >
                      <div className="mb-2 bg-gradient-to-br from-yoobe-purple to-fuchsia-600 bg-clip-text text-4xl font-black text-transparent lg:text-5xl">
                        {metric.value}
                      </div>
