  ...
  return (
    <div className="pt-32 pb-24 bg-[#0a0f18] min-h-screen text-white flex items-center justify-center">
      <div className="container mx-auto px-4 max-w-4xl text-center">
        <div className="w-20 h-20 mx-auto bg-brand-orange/20 rounded-full flex items-center justify-center mb-8 border border-brand-orange/30">
          <Zap className="w-10 h-10 text-brand-orange" />
        </div>
        <h1 className="text-4xl md:text-6xl font-black mb-6 font-heading">
          Motor de <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-orange to-red-500">Gamificação</span>
        </h1>
