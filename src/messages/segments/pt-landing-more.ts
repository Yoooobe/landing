export const ptLandingMore = {
    ...
    stages: [
      {
        ...
        items: [
          ...
          "Segmentação guiada por dados",
          "Contexto unificado (HRIS + eventos)",
          "Sinais de engajamento e próximos passos",
        ],
      },
      {
        ...
        items: [
          "Montagem inteligente de kits",
          "Recomendações em tempo real",
          "Catálogo dinâmico por perfil",
          "Inteligência de recompensas",
        ],
      },
      {
        ...
        status: "Automação",
        items: [
          "Missões e fluxos adaptativos",
          "Automações acionadas por evento",
          "Integrações, feeds e webhooks",
          "Engajamento com agentes (playbooks)",
        ],
      },
      {
        ...
        status: "Decisão",
        items: [
          "Insights para RH com IA",
          "Copiloto de budget e campanhas",
          "Retenção e saúde do time",
  ...
  plataformaStubs: {
    ...
    motor: {
      titleBefore: "Motor de",
      titleGradient: "Gamificação",
      body:
        "Esta página está reservada para detalhar as regras do motor de gamificação, setups de campanhas temporárias e pontuação peer-to-peer.",
    },
    logistica: {
      titleBefore: "Logística",
      titleGradient: "Integrada",
      body:
        "Esta página será usada para explorar o módulo de entregas D+1, rastreamento Last-Mile e armazenamento de kits onboarding.",
    },
    loja: {
      titleBefore: "Loja Corporativa e",
      titleGradient: "Resgates",
      body:
  ...
  enterpriseCases: {
    ...
    hapvida: {
      ...
      mockDailyLabel: "Acessos Diários",
    ...
    prio: {
      ...
      mockDeliveryLabel: "Status de Entrega",
      mockDeliveryStatus: "Em trânsito",
    },
  },
  dedicatedIntegrations: {
    ...
    workvivo: {
      ...
      feedCardTitle: "Kit Celebração Vendas",
      feedCardBrand: "4Unik Rewards",
      feedCta: "Resgatar",
      realtime: "Em tempo real",
      bullets: [
        "O colaborador não precisa criar outra senha ou login",
        "Notificações enviadas direto no app mobile do Workvivo",
        "Gestão unificada: RH não precisa operar 2 telas separadas",
      ],
    },
    beehome: {
      title: "Beehome",
      ...
      yoobeStoreSub: "Logística & Envios",
      bullets: [
        "O colaborador gasta o saldo Beehome e a 4Unik faz a entrega",
        "Totalmente fluído, as plataformas se conversam o tempo todo",
        "Fim do processo manual de comprar prêmios para a intranet",
      ],
    },
  },
} as const;
