export const enLandingMore = {
    ...
    stages: [
      {
        ...
        items: [
          ...
          "Unified context (HRIS + events)",
          "Engagement signals and next best actions",
        ],
      },
      {
      ...
      },
      {
        ...
        status: "Automation",
        items: [
          "Adaptive missions and flows",
          "Event-driven automations",
          "Integrations, feeds, and webhooks",
          "Agent-led engagement playbooks",
        ],
      },
      {
        title: "Strategy & ROI",
        status: "Decision",
        items: [
          "AI insights for HR leaders",
          "Budget and campaign copilot",
          "Retention and team health",
          "Risk and attrition forecasting",
        ],
      },
    ],
  },
  ...
  plataformaStubs: {
    ...
    motor: {
      titleBefore: "Gamification",
      titleGradient: "Engine",
      body:
        "This page will detail gamification rules, campaign configurations, and peer-to-peer scoring.",
    },
    logistica: {
      titleBefore: "Integrated",
      titleGradient: "Logistics",
      body:
        "This page will cover D+1 delivery, last-mile tracking, and welcome-kit storage.",
    },
    loja: {
      titleBefore: "Corporate store &",
      titleGradient: "Redemptions",
      body:
        "This page will go deeper into the rewards catalog, B2C-style employee experiences, and multi-currency redemption.",
    },
  },
  enterpriseCases: {
    ...
    hapvida: {
      ...
      mockDailyLabel: "Daily sessions",
      mockDailyValue: "+10k avg",
    },
    prio: {
      tag1: "Energy / Oil & gas",
      tag2: "VIP corporate store",
      bodyBefore: "A fully ",
      ...
      mockDeliveryLabel: "Delivery status",
      mockDeliveryStatus: "In transit",
    },
  },
  dedicatedIntegrations: {
    ...
    workvivo: {
      ...
      feedPost:
        "Congrats sales team on hitting the goal! 🏆 Redeem your exclusive rewards on the platform.",
      feedCardTitle: "Sales celebration kit",
      feedCardBrand: "4Unik Rewards",
      feedCta: "Redeem",
      realtime: "Real time",
      bullets: [
        "No extra password or login for employees",
        "Notifications delivered in the Workvivo mobile app",
        "Unified ops—HR doesn’t juggle two separate consoles",
      ],
    },
    beehome: {
      title: "Beehome",
      ...
      yoobeStoreSub: "Logistics & shipping",
      bullets: [
        "Employees spend Beehome balance and 4Unik handles fulfillment",
        "Platforms stay in sync continuously",
        "No more manual buying of intranet prizes",
      ],
    },
  },
} as const;
