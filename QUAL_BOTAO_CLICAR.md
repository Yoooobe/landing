# 🎯 Qual Botão Clicar no Google Cloud DNS

## ✅ Resposta Rápida

**Clique em: `+ Add standard`**
...
3. **`Delete record sets`** ❌ Não use agora
...
**Botão correto:** `+ Add standard` ✅

Este botão abre o formulário para adicionar registros DNS simples como o registro A que você precisa!
