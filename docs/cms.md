...
- **Checklist pós-geração (editorial):** após aplicar a imagem ao campo, define **texto alternativo** (`alt`) onde o schema o permitir; verifica **proporção** e peso do ficheiro antes de publicar; conteúdo gerado por IA está sujeito a **políticas do fornecedor** e revisão humana para marca e precisão.
