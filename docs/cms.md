...
- **Backend incluído no repo:** existe um serviço mínimo em [`nano-banana-api/`](../nano-banana-api/) (OpenAI DALL·E 3, deploy na Vercel). Segue o [README do pacote](../nano-banana-api/README.md); o valor do secret deve ser a URL completa do endpoint, por exemplo `https://<projeto>.vercel.app/api/generate`.
